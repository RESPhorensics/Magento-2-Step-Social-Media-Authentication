...
class SocialLogon_Helper_Twitter extends Mage_Core_Helper_Abstract
{
    ...
    public function getCustomersByTwitterId($twitterId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToSelect('SocialLogon_ttoken')
            ->addAttributeToFilter('SocialLogon_tid', $twitterId)
            ->setPageSize(1);
