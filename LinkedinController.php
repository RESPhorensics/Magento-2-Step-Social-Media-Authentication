...
class SocialLogon_LinkedinController extends SocialLogon_Controller_Abstract
{

    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        Mage::helper('SocialLogon/linkedin')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $info = Mage::getModel('SocialLogon/linkedin_info')->load();
            /* @var $info SocialLogon_Model_Linkedin_Userinfo */

            $token = $info->getClient()->getAccessToken();

            $customersByLinkedinId = Mage::helper('SocialLogon/linkedin')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('SocialLogon/linkedin')->connectByLinkedinId(
                    $customer,
                    $info->getId(),
                    $token
                );
            ...
            if($customersByLinkedinId->getSize()) {
                ...
                Mage::helper('SocialLogon/linkedin')->loginByCustomer($customer);
            ...
            $customersByEmail = Mage::helper('SocialLogon/linkedin')
            ...
            Mage::helper('SocialLogon/linkedin')->connectByCreatingAccount(
