...
class SocialLogon_Helper_Linkedin extends Mage_Core_Helper_Abstract
{
    ...
    public function disconnect(Mage_Customer_Model_Customer $customer) {
        ...
        $pictureFilename = Mage::getBaseDir(Mage_Core_Model_Store::URL_TYPE_MEDIA)
                ...
                .'linkedin'
                .DS
                .$customer->getSocialLogonLid();

        if(file_exists($pictureFilename)) {
            @unlink($pictureFilename);
        }

        $customer->setSocialLogonLid(null)
        ->setSocialLogonLtoken(null)
        ->save();
    }
    ...
    public function connectByLinkedinId(
            ...
            $token)
    {
        $customer->setSocialLogonLid($linkedinId)
                ->setSocialLogonLtoken($token)
                ->save();
    ...
    public function getCustomersByLinkedinId($linkedinId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToSelect('SocialLogon_ltoken')
            ->addAttributeToFilter('SocialLogon_lid', $linkedinId)
            ->setPageSize(1);
