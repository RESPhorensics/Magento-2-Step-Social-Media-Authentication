...
class SocialLogon_Helper_Google extends Mage_Core_Helper_Abstract
{

    public function disconnect(Mage_Customer_Model_Customer $customer) {
        $client = Mage::getSingleton('SocialLogon/google_oauth2_client');

        // TODO: Move into SocialLogon_Model_Google_Info_User
        try {
    ...
    public function getCustomersByGoogleId($googleId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToSelect('SocialLogon_gtoken')
            ->addAttributeToFilter('SocialLogon_gid', $googleId)
            ->setPageSize(1);
