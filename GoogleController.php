...
class SocialLogon_GoogleController extends SocialLogon_Controller_Abstract
{

    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        Mage::helper('SocialLogon/google')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $info = Mage::getModel('SocialLogon/google_info')->load();
            /* @var $info SocialLogon_Model_Google_Info */

            $token = $info->getClient()->getAccessToken();

            $customersByGoogleId = Mage::helper('SocialLogon/google')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('SocialLogon/google')->connectByGoogleId(
                    $customer,
                    $info->getId(),
                    $token
                );
            ...
            if($customersByGoogleId->getSize()) {
                ...
                Mage::helper('SocialLogon/google')->loginByCustomer($customer);
            ...
            $customersByEmail = Mage::helper('SocialLogon/google')
            ...
            Mage::helper('SocialLogon/google')->connectByCreatingAccount(
                $info->getEmail(),
                $info->getGivenName(),
                $info->getFamilyName(),
                $info->getId(),
